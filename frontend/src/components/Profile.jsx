  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center ">
      ...
      <div className="w-[450px] relative  h-[500px] rounded-2xl overflow-hidden border-2 border-neutral-300 shadow-[0px_1px_4px_0px_rgba(255,255,255,0.1)_inset,0px_-1px_2px_0px_rgba(255,255,255,0.1)_inset]">
        ...
        />
        <div className="absolute bottom-0 left-0 pl-8 pb-8  ">
          <h3 className="text-4xl font-semibold text-white/80 flex gap-3  items-center ">
            {((name).toUpperCase())},
            <span className="font-light text-2xl ">{Age}</span>
          </h3>
          <h4 className="flex items-center gap-2 text-lg mb-4 mt-2 text-white/80 ">
            <span>
              <MdOutlineWorkOutline />
            </span>
            {university}
          </h4>
          <h4 className="flex items-center gap-2 text-lg mb-4 text-white/80">
            <span>
